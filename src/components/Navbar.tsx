    ...
    >
      <div className="container mx-auto px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src={logo} alt="EverRise & Embers logo" className="h-10 w-10 object-contain" />
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-body text-muted-foreground">
          ...
          <a href="#custom" className="hover:text-primary transition-colors duration-300">Custom Cakes</a>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-4 py-2 rounded-full text-sm font-body text-primary-foreground bg-gradient-to-r from-ember to-ember-glow transition-colors duration-300 flex items-center gap-2"
          >
